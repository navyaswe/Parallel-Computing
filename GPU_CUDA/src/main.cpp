...
void train_model() {
	...
	for (int e = 0; e < epochs; e++) {
		...
		images.open("../../datasets/train-images.idx3-ubyte", ios::binary);
		labels.open("../../datasets/train-labels-idx1-ubyte", ios::binary);
...
void test_all() {
	...
	images.open("../../datasets/t10k-images-idx3-ubyte", ios::binary);
	labels.open("../../datasets/t10k-labels-idx1-ubyte", ios::binary);
